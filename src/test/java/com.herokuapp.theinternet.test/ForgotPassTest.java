...
public class ForgotPassTest {
    ...
    public void fileUploaderTest(){
        ...
        driver.findElement(By.xpath("//*[@id=\"file-upload\"]")).sendKeys("d:\\TMS\\Herokuapo\\uploadfile.txt");
        driver.findElement(By.xpath("//*[@id=\"file-submit\"]")).click();
        WebElement fileUploaded = driver.findElement(By.cssSelector("#content > div > h3"));
        String fileUploadedText = fileUploaded.getText();
...
//        System.out.println(alertText);
    ...
    public void dynamicControlsTest(){
        ...
        WebElement deleteButton = driver.findElement(By.cssSelector("#checkbox-example > button"));
